...
@section('breadcump')
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ __('Video Slide') }}</li>
        </ol>
    </div>
@endsection
                    ...
                    <div class="card-tools d-flex align-items-center justify-content-between">
                        @can('add user')
                            <div class="text-right mb-3">
                                <a href="{{ route('backend.video_slides.create') }}" class="btn btn-primary">
                        ...
                        <table class="table table-hover">
                            ...
                            @forelse ($services as $service)
                                <tr>
                                    ...
                                    <td>
                                        @can('change service')
                                            <a href="{{ route('backend.video_slides.edit', $service) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="text-center text-muted"><i>{{ __('No Video Slide Found') }}</i>
                                    </td>
                                </tr>
                            @endforelse
                            </tbody>
