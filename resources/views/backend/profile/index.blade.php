...
@section('main')
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    <div class="text-center">
                        ...
                        @else
                            <img src="{{ asset($profile->image) }}" class="profile-user-img img-fluid img-circle"
                                alt="User Image">
                        @endif
            ...
            {{--                <hr> --}}
            {{--                <strong><i class="fas fa-calendar mr-1"></i> {{ __('User since') }}</strong> --}}
            {{--                <p class="text-muted"> --}}
        ...
        {{--                                            name="phone_number" --}}
        {{--                                            value="{{ old('phone_number', $profile->telephone) }}"> --}}
        {{--                                        @error('telephone') --}}
        {{--                                        <small class="invalid-feedback">{{ $message }}</small> --}}
        {{--                                        @enderror --}}
        {{--                                    </div> --}}
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="updateImageLabel">{{ __('Update profile picture') }}</h5>
