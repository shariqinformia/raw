    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('pdf.show', $pdf->slug) }}" method="POST" id="passwordForm">
                    @csrf
                    <div class="mb-3">
    ...
    <div class="container-fluid header">
        <div class="row">
            <div class="col-sm-12 col-sm-12">
                <div class="fakeimg">{{ $pdf->name }}</div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div id="fullView" class="fullView" style="display: none">
                    <p class="fakeimg">{{ $pdf->description }}</p>
                    @if ($pdf->videos && $pdf->videos->isNotEmpty())
                ...
                <div id="passView" class="passView">
                    ...
                    @if ($pdf->videos && $pdf->videos->isNotEmpty())
                        <div class="service-images">
                            @foreach($pdf->service_pdfs->take($pdf->default_no_of_pdfs) as $service_pdf)
                    ...
                    @else
                        <p>No pdfs available for this service.</p>
                    @endif
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="contactForm" method="POST">
                                @csrf
                                <input type="hidden" name="service_id" value="{{$pdf->id}}">
                                <div class="mb-3">
