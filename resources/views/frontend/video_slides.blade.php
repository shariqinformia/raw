    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('video_slides.show', $slug->slug) }}" method="POST" id="passwordForm">
                    @csrf
                    <div class="mb-3">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div id="fullView" class="fullView" style="display: none">
                    ...
                    @if ($slug->videos && $slug->videos->isNotEmpty())
                        <div class="service-images">
                            @foreach($slug->videos as $video)
                ...
                <div id="passView" class="passView">
                    ...
                    @if ($slug->videos && $slug->videos->isNotEmpty())
                        <div class="service-images">
                            @foreach($slug->videos->take($slug->default_no_of_videos) as $video)
                                <video width="320" height="240" controls class="mb-2">
                                    <source src="{{ asset('uploads/video_slides/' . $video->file_name) }}" type="video/mp4">
                                    Your browser does not support the video tag.
                                </video>
